...
<html>
  ...
  <body>
  	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  		<legend>新增系统账号</legend>
	</fieldset>
	<form class="layui-form" method="post" id="form1">
		<input type="hidden"  name="menuid" value=${param.menuid}>
		<input type="hidden"  name="dpName"  id="dpName">
	   <div class="layui-form-item">
	   <div class="layui-inline">
	    		<label class="layui-form-label"><font color="red" size=2>*</font>用户姓名</label>
	    		<div class="layui-input-inline">
	      			<input type="text" name="staffName" id="staffName" lay-verify="required" autocomplete="off" style="width:270%"
		...
		<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	    			<input type="text" name="cardnumber" id="cardnumber"  autocomplete="off"  class="layui-input" placeholder="请输入身份证号">
	      		</div>
	       	</div>
	       	<div class="layui-inline">
	    		<label class="layui-form-label">警号</label>
	    		<div class="layui-input-inline">
	      			<input type="text" name="alarmsignal" id="alarmsignal"  autocomplete="off" placeholder="请输入警号" class="layui-input"  >
	      		</div>
	       	</div>	    	       	
	 	</div>
	 	<div class="layui-form-item">
	 	...
	 	<div class="layui-form-item">
	       	...
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="departmentid" id="departmentid" lay-verify="required" autocomplete="off"  class="layui-input"  lay-reqtext="所属部门不能为空">
	      		</div>
	       	</div>
	 	</div>
		<div class="layui-form-item">
	       	<div class="layui-inline">
	    		<label class="layui-form-label"><font color="red" size=2>*</font>系统账号</label>
	    		<div class="layui-input-inline">
	      			<input type="text" name="usercode" lay-verify="required" autocomplete="off" placeholder="请设置账号" class="layui-input"  lay-reqtext="系统账号不能为空">
	      		</div>
	       	</div>
	       	<div class="layui-inline">
	       		<label class="layui-form-label"><font color="red" size=2>*</font>登录密码</label>
	    		<div class="layui-input-inline">
	      			<input type="text" name="userpassword" lay-verify="required" autocomplete="off" placeholder="请设置密码" class="layui-input"  lay-reqtext="密码不能为空">
	      		</div>
	       	</div>
	 	</div>
