  ...
  <legend>菜单信息</legend>
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <select name="parentid" id="parentid" lay-filter="aihao">
        <c:forEach items="${menuList }" var="row" varStatus="num">
		<option value="${row.id }" <c:if test="${row.id == menu.parentid }">selected</c:if>>${row.menuname }</option>
		</c:forEach>
      </select>
    </div>
  </div>
 ...
 <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="url"  autocomplete="off" class="layui-input" value="${menu.url }">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
