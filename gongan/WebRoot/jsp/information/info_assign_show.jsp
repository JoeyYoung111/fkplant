...
<br><br>
	...
	<div class="div-left">
		<font style="font-size:20px">${info.departmentname}</font>
	</div>
	<div class="div-right">
	...
	<div align="center">
		<h1 style="letter-spacing:10px;font-size:25px">${info.assigntitle}</h1>
	</div>

	<br><br>

	<div>
		<p style="text-indent:2em;font-size:30px;font-family:'楷体'">${info.assigncontent}</p>
	</div>
	...
	<div>
		<font style="font-size:20px">【交办签收反馈信息】</font>
	</div>
	<div>
		<table style="margin:10px auto;" border="1px;">
			...
			<thead>
				<tr>
					...
					<th style="line-height:30px">交办单位</th>
