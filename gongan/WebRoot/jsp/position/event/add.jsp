	...
	<form class="layui-form" method="post" id="form1">
		...
		<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline">
	      		<input type="text" name="eventTime" lay-verify="required" autocomplete="off" placeholder="请输入活动时间" class="layui-input"  lay-reqtext="活动时间不能为空">
	    	</div>
	  	</div>
		<div class="layui-form-item">
	    	<label class="layui-form-label"><font color="red" size=2>*</font>活动简况</label>
	    	<div class="layui-input-inline" style="width:660px;">
	      		<input type="text" name="eventInfo" lay-verify="required" autocomplete="off" placeholder="请输入活动简况" class="layui-input"  lay-reqtext="活动简况不能为空">
	    	</div>
	  	</div>
		<div class="layui-form-item">
		...
		layui.use(['form', 'laydate'], function(){
		  ...
		  form.render();
		   form.on('submit(roleSub)', function(data){
             ...
             $("#form1").ajaxSubmit({
	              	url:		'<c:url value="/addPositionEvent.do"/>',
	              	dataType:	'json',
	              	async:  false,
