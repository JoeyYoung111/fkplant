	...
	<form class="layui-form" method="post" id="form1">
		...
		<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline">
	      		<input type="text" name="cardname" lay-verify="required" autocomplete="off" placeholder="请输入名称" class="layui-input"  lay-reqtext="名称不能为空">
	    	</div>
		...
		<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline">
	      		<input type="text" name="validdate" autocomplete="off" class="layui-input">
	    	</div>
	    	<label class="layui-form-label">发证单位</label>
	    	<div class="layui-input-inline">
	      		<input type="text" name="cardunit" autocomplete="off" class="layui-input">
	    	</div>
	  	</div>
		<div class="layui-form-item">
		...
		layui.use(['form', 'laydate'], function(){
		  ...
		  form.render();
		   form.on('submit(roleSub)', function(data){
             ...
             $("#form1").ajaxSubmit({
	              	url:		'<c:url value="/addPositionCard.do"/>',
	              	dataType:	'json',
	              	async:  false,
