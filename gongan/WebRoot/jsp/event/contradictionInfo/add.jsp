...
<html>
  ...
  <body>
  	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  		<legend id="typeName">添加矛盾风险信息</legend>
	</fieldset>
	<form class="layui-form" method="post" id="form1">
		...
		<div class="layui-form-item">
	  	...
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline" style="width:52.5%;" id="cdttype">
			</div>
		...
		<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline" style="width:15%;">
        		<input type="text" name="sjje" value="0" lay-verify="number" autocomplete="off" class="layui-input" placeholder="请输入涉及金额"/>
      		</div>
	  	...
	  	<div class="layui-form-item layui-form-text">
		    ...
		    <div class="layui-input-inline" style="width:52.5%;">
		      <textarea placeholder="请输入内容" class="layui-textarea" name="cdtcontent" lay-verify="required" lay-verType="tips"></textarea>
		    </div>
		</div>
	    <div class="layui-form-item layui-form-text">
		    <label class="layui-form-label">具体诉求</label>
		    <div class="layui-input-inline" style="width:52.5%;">
		    	<input type="text" name="jtsq"  autocomplete="off" class="layui-input" placeholder="请输入具体诉求"/>
		    </div>
		</div>
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline" style="width:20%;" lay-verify="sponsorverify">
	  	...
	  	<div  class="layui-form-item">
			...
			<div class=layui-input-inline style="width:52.5%;">
				<input type="text" name="ssdwxx"  autocomplete="off" class="layui-input" maxlength="100" placeholder="请输入涉事单位名称+单位负责人+联系电话"/>
			</div>
		</div>
		<div  class="layui-form-item">
			<label class="layui-form-label">属地派出所领导信息</label>
			<div class=layui-input-inline style="width:52.5%;">
				<input type="text" name="sdpcsldxx"  autocomplete="off" class="layui-input" maxlength="100" placeholder="请输入属地派出所分管领导+联系电话"/>
			</div>
		</div>
		<div  class="layui-form-item">
			<label class="layui-form-label">属地派出所社区民警信息</label>
			<div class=layui-input-inline style="width:52.5%;">
				<input type="text" name="sdpcsmjxx"  autocomplete="off" class="layui-input" maxlength="100" placeholder="请输入属地派出所民警+联系电话"/>
			</div>
		</div>
		<div  class="layui-form-item">
			<label class="layui-form-label">政府牵头处置部门</label>
			<div class=layui-input-inline style="width:52.5%;">
				<input type="text" name="zfqtmbxx"  autocomplete="off" class="layui-input" maxlength="100" placeholder="请输入部门+领导+联系电话"/>
			</div>
		</div>
		<div  class="layui-form-item">
		...
		<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline" style="width:15%;">
	      		<select id="isjq"  name="isjq" style="width:170px;">
			        <option value="0">否</option>
			        <option value="1">是</option>
			 	</select>
	    	</div>
	    	<div class="layui-input-inline" style="width:37%;">
	    		<input type="text" name="qxx" autocomplete="off" class="layui-input" maxlength="100" placeholder="请输入群信息"/>
			</div>
	    </div>
	    <div class="layui-form-item">
	  		<label class="layui-form-label">是否物建信息员</label>
	    	<div class="layui-input-inline" style="width:15%;">
	      		<select id="iswjxxy"  name="iswjxxy" style="width:170px;">
			        <option value="0">否</option>
			        <option value="1">是</option>
			 	</select>
	    	</div>
	    	<div class="layui-input-inline" style="width:37%;">
	    		<input type="text" name="xxyxx" autocomplete="off" class="layui-input" maxlength="100" placeholder="请输入信息员信息"/>
			</div>
	    </div>
	  	<div class="layui-form-item layui-form-text">
	...
	<script type="text/javascript">
		...
		layui.use(['form', 'layedit', 'laydate','zTreeSelectM','treeSelect','selectInput'], function(){
			var form = layui.form,
			layer = layui.layer,
			...
			form.verify({
		    	cdtnameverify: function(value,item){
		    		if(!$('input[name=cdtname]').val()||$("#sponsor").val()==""){
			...
			$.ajax({
				type:		'POST',
				url:		'<c:url value="/searchCdtname.do"/>',
				dataType:	'json',
				success:	function(data){
					var cdtdata=[];
					$.each(data.data,function(item,items){
						cdtdata[item]={value: items, name: items};
					});
					selectInput.render({
			            elem: '#cdtname',// 容器id，必传参数
		  ...
		  form.on('submit(msgSub)', function(data){
		  	$("#form1").ajaxSubmit({
	              	url:		'<c:url value="/addContradictionInfo.do"/>',
	              	dataType:	'json',
	              	async:  false,
	              	success:	function(data) {
	                  	var obj = eval('(' + data + ')');
