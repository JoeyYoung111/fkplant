...
<form class="layui-form" method="post" id="form_information" onsubmit="return false;" style="margin-bottom: 100px;">
	...
	<div class="layui-row">
		...
		<div class="layui-form-item">
			...
			<div class="layui-col-md11">
				<div class="layui-col-md11">
					<div class="layui-input-block">
						<input type="text" name="infotitle" class="layui-input" lay-verify="required" lay-reqtext="请输入标题" autocomplete="off" value="${param.infotitle }"/>
					</div>
				</div>
			</div>
		</div>
...
function openUnits(){
	var index = layui.layer.open({
		title :	"其他报送部门",
		type:	2,
		content:'<c:url value="/jsp/event/contradictionInfo/leadsInfo/units.jsp"/>?idlist1='+$("#submitunitid").val()+"&idlist2="+$("#otherunitids").val(),
		area:	['1000px','780px'],
		maxmin:	true,
...
$(document).ready(function(){
	...
	//初始化数据
	$("select[name^=infostate]").val("${param.infostate}");
	$("#infocontent").val("线索内容：<br>${param.lcontent}<br>处置情况概述:<br>${param.czqkgs}");
});
