...
layui.use(['table','form','zTreeSelectM'], function(){
  ...
  table.render({
    ...
    url: '<c:url value="/searchContradictionInfo.do"/>?nowstate=1&isshield=-1',
    method:'post',
    toolbar: '#toolbarDemo',
    cols: [[
    	{field:'id',type:'radio',fixed:'left'},
    	{field:'rkdept', title: '入库单位', width:150,align:"center"},
    	{field:'addtime', title: '入库时间', width:160,align:"center"},
    	{field:'cdtname', title: '风险名称',align:"center",templet:
    		function(d){
    	...
    	{field:'ssrs', title: '涉事人数', width:90,align:"center"},
			...
			case 'check':
				...
				if(datas!=""){
					...
					var index = layui.layer.open({
						...
						content : '<c:url value="getCheckContradictionInfo.do"/>?id='+id+'&menuid='+${param.menuid },
						area: ['800', '800px'],
						maxmin: true,
