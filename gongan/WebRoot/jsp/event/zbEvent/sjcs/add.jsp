...
<html>
  ...
  <body>
  	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  		<legend id="typeName">添加涉及场所信息</legend>
	</fieldset>
	<form class="layui-form" method="post" id="form1">
		...
		<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline">
	      		<input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="请输入场所名称" class="layui-input"  lay-reqtext="场所名称不能为空">
	    	</div>
	    	<label class="layui-form-label"><font color="red" size=2>*</font>场所地址</label>
	    	<div class="layui-input-inline">
	      		<input type="text" name="memo" lay-verify="required" autocomplete="off" placeholder="请输入场所地址" class="layui-input"  lay-reqtext="场所地址不能为空">
	    	</div>
	  	</div>
	  	<div class="layui-form-item">
...
<%--	    		<input type="text" name="result" lay-verify="required" autocomplete="off" placeholder="请输入处理结果" class="layui-input"  lay-reqtext="处理结果不能为空">--%>
	    		<select name="result" autocomplete="off" lay-verify="required" lay-verType="tips" lay-reqtext="请选择处理结果">
					...
					<option value="依法取缔">依法取缔</option>
					<option value="责令停止活动">责令停止活动</option>
				</select>
	    	</div>
	  	</div>
		<div class="layui-form-item">
