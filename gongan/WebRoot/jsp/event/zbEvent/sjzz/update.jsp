	...
	<form class="layui-form" method="post" id="form1">
		...
		<div  class="layui-form-item">
			...
			<div class=layui-input-inline style="width:52.5%;">
				<input type="text" name="name" value="${zbEventInfo.name }" autocomplete="off" class="layui-input" maxlength="50" placeholder="请输入组织名称"  lay-verify="required" />
			</div>
		</div>
	  	<div class="layui-form-item layui-form-text">
		    <label class="layui-form-label">备注</label>
		    <div class="layui-input-block">
		      <textarea placeholder="请输入备注" class="layui-textarea" name="memo">${zbEventInfo.memo }</textarea>
		    </div>
		</div>
		<div class="layui-form-item">
		    <div class="layui-input-block">
