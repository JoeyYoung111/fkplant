...
<html>
  ...
  <body>
  	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  		<legend id="typeName">添加涉及物品</legend>
	</fieldset>
	<form class="layui-form" method="post" id="form1">
		...
		<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline">
	      		<input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="请输入物品名称" class="layui-input"  lay-reqtext="物品名称不能为空">
	    	</div>
	    	<label class="layui-form-label"><font color="red" size=2>*</font>物品类型</label>
	    	<div class="layui-input-inline">
<%--	      		<input type="text" name="type" lay-verify="required" autocomplete="off" placeholder="请输入物品类型" class="layui-input"  lay-reqtext="物品类型不能为空">--%>
	    		<select name="type" autocomplete="off" lay-verify="required" lay-verType="tips" lay-reqtext="请选择物品类型">
					...
					<option value="作案工具">作案工具</option>
					<option value="资金资产">资金资产</option>
					<option value="反宣品">反宣品</option>
	  	...
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline">
<%--	    		<input type="text" name="result" lay-verify="required" autocomplete="off" placeholder="请输入处理结果" class="layui-input"  lay-reqtext="处理结果不能为空">--%>
