...
<div class="demoTable">
 ...
 <div class="layui-inline">
    <input class="layui-input" name="id" id="demoReload4" autocomplete="off" value=" 操作单位：" onfocus="if(this.value == ' 操作单位：'){ this.value = '';}" onblur="if(this.value =='') {this.value = ' 操作单位：'}">
 </div>
...
layui.use(['table','laydate'], function(){
  ...
  table.render({
    ...
    url: '<c:url value="/getEventLog.do"/>',
    where:{parentmenuname:'风险事件'},
    method:'post',
    cols: [[
      {field:'menuname', title: '操作菜单', width:280,align:"center"} ,
      ...
      {field:'operatedept', title: '操作单位', width:160,align:"center"} ,
  				...
  				if(startTimes<=endTimes){
  					table.reload('followTable', {
						where: { // 设定异步数据接口的额外参数，任意设
							...
							operatedept: ($("#demoReload4").val()==" 操作单位：")?"":$("#demoReload4").val(),
