  ...
  <div class="showinfo">
	<table width="100%" border="1" cellspacing="0" cellpadding="0">
		<tr height="40" bgcolor="#3598DC">
    		<td colspan="4"><span class="showinfo_title">通知公告详情</span></td>
  		</tr>
		<tr>
	    	<td width="15%">通知公告类型</td>
	    	<td width="35%">${notice.noticetype }</td>
	    	<td width="15%">标题</td>
	    	<td width="35%">${notice.noticetitle }</td>
	    </tr>
	    <tr>
			<td width="15%">通知内容</td>
			<td width="80%" colspan="3">${notice.noticetext }</td>
		</tr>
	    <tr>
			<td width="15%">发送部门</td>
			<td width="80%" colspan="3">${notice.departnames }</td>
		</tr>
		<tr>
	    	<td width="15%">附件信息</td>
