...
<body>
<form class="layui-form" method="post" id="form_messenger">

	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 5px;">
		<legend>添加办证人员信息</legend>
	</fieldset>
	...
	<div class="layui-form-item">
	    <div class="layui-input-block">
	      <button type="submit" class="layui-btn licence-btn-submit" lay-submit="" lay-filter="ADDMessenger">立即提交</button>
	      <button type="reset" class="layui-btn layui-btn-primary" id="ADDMessengerReset">重置</button>
	    </div>
  	</div>
...
layui.use('form',function(){
	...
	form.on('submit(ADDMessenger)',function(data){
	...
	function addMessenger(){
		$("#form_messenger").ajaxSubmit({
			url:		'<c:url value="/addMessenger.do"/>',
			dataType:	'json',
			async:		false,
			success:	function(data) {
				var obj = eval('(' + data + ')');
