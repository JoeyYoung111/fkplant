...
<html>
 ...
 <div class="layui-upload" style="width:535px;margin-left:25px;">
	...
	$("#upload").on("click",function(){
		//window.location.href="<c:url value='/jsp/company/易制毒化学品单位导入模板.xlsx' />";
		window.location.href="<c:url value='/jsp/company/风险单位导入模板.xlsx' />";
	});
 ...
 uploadListIns=upload.render({
    elem:'#files',
  url: '<c:url value="/importCompany.do" />?companytype=${param.companytype}',
 accept:'file',     //文件类型
 exts: 'xls|xlsx',
 multiple:true,     //多文件上传
