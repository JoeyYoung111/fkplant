...
<script type="text/javascript">
			...
			switch(obj.event){
				case 'add':
					var index = layui.layer.open({
						...
						content : locat+"/jsp/company/custom/add.jsp?menuid="+tempid+"&companytype="+$("#companytype").val()+"&companytypename="+thistitle,
						area : ['800', '700px'],
						maxmin: true,
				...
				case 'update':
					...
					if(datas!=""){
						...
						var index = layui.layer.open({
							...
							type:	2,
							content:locat+'/getCompanyById.do?id='+id+"&page=updateCustom&menuid="+tempid,
							area:	['800', '700px'],
							maxmin:	true,
							success:function(layero, index){
								setTimeout(function(){
	...
	function showInfoCompany(id){
		var index = layui.layer.open({
			title	:thistitle+"-详情",
			type	:2,
			content	:locat+'/getCompanyById.do?id='+id+"&page=showinfoCustom&menuid="+${param.menuid},
			area	:['800', '700px'],
			maxmin	:true,
			success	:function(layero,index){
