...
<%--									<input type="text" class="layui-input" style="height:65px;" name="managerange" id="managerange" value="${company.managerange }" autocomplete="off"/>--%>
									<textarea name="managerange" id="managerange" class="layui-textarea">${company.managerange }</textarea>
								</td>
							</tr>
							<tr>
						...
						<table class="layui-table" lay-even>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<select name="politicalposition" id="politicalposition" lay-filter="politicalposition" lay-reqtext="请选择政治面貌"></select>
									</td>
								</tr>
								<tr>
