...
<html>
 <head>
	...
	<script type="text/javascript" src="<c:url value="/jsp/personel/personel221018.js?v=20250519"/>"></script><!-- 头像编辑、关联信息 、社会关系 数据处理js -->
			...
			<div class="layui-col-md6" style="border-right: 1px solid #eee">
				...
				<div class="layui-row" style="padding: 1px;">
					<table class="layui-table" lay-even>
						...
						<thead>
							<tr>
								<th colspan="6" class="layui-bg-blue layui-font-16 my-text-nowarp">其他信息</th>
							</tr>
						</thead>
						<tbody>
						   <tr>
								<td class="text-align-r my-text-nowarp">涉政级别：</td>
								<td colspan="2">${personnelExtend.jointcontrollevel}</td>
								<td colspan="3"></td>
							</tr>
							<tr>
								<td class="text-align-r my-text-nowarp">列控依据：</td>
								<td colspan="5">${personnelExtend.memo}</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="text-align-r my-text-nowarp">双管辖责任单位：</td>
								<td>${personnel.policephone}</td>
								<td class="text-align-r my-text-nowarp">双管辖责任民警：</td>
								<td>${personnel.incontrolleve}</td>
								<td class="text-align-r my-text-nowarp">民警手机：</td>
								<td>${personnel.pphone2}</td>
							</tr>
						   <tr>
							   <td class="text-align-r my-text-nowarp">管控力量：</td>
							   <td colspan="5"><a onclick="openRelation('controlpower',${personnel.id},0);"><u>${personnel.control_power}</u></a></td>
						   </tr>
						   <tr>
							   <td class="text-align-r my-text-nowarp">管控方案：</td>
							   <td colspan="5"><a onclick="openRelation('controlplan',${personnel.id},0);"><u>${personnel.control_plan}</u></a></td>
						   </tr>
						   <tr>
							   <td class="text-align-r my-text-nowarp">应急预案：</td>
							   <td colspan="5"><a onclick="openRelation('controlemergency',${personnel.id},0);"><u>${personnel.control_emergency}</u></a></td>
						   </tr>
			...
			<div class="layui-col-md6">
				<div class="layui-tab">
				  <%--<ul class="layui-tab-title btn-list">
						...
						<li class="btn btn_4" onclick="openCustomlabel(${personnelExtend.personlabelid})">自定义标签</li>
					</ul>
					--%>
									...
									<div class="layui-tab-item layui-show">
										<table class="layui-table" lay-even>
											...
											<tbody>
												<tbody>
													<tr>
														<td class="text-align-r my-text-nowarp">国籍</td>
														<td>${personnelExtend.country}</td>
													</tr>
													<tr>
														<td class="text-align-r my-text-nowarp">出生日期</td>
														<td>${personnelExtend.birthday}</td>
													</tr>
													<tr>
														<td class="text-align-r my-text-nowarp">身份/职业</td>
														<td>${personnelExtend.vocation}</td>
													</tr>
													<tr>
														<td class="text-align-r my-text-nowarp">工作单位</td>
														<td>${personnelExtend.workunit}</td>
													</tr>
													<tr>
														<td class="text-align-r my-text-nowarp">职务</td>
														<td>${personnelExtend.workjob}</td>
													</tr>
												</tbody>
										</table>
									</div>
							...
							<table class="layui-table">
								<tr>
									<td valign="top" width="28%">		
										<ul id="tagTree" class="tagtree" style="width:98%;overflow: auto;height: 680px;">
									...
									<td valign="top" width="72%"> 
										<div id="label" style="height: 680px;display:none;">
											...
											<div class="layui-form-item my-form-item">
												<label class="my-form-label-br">标签信息
											...
											<div class="layui-form-item my-form-item">
												<label class="my-form-label-br">备注信息
												<div class="my-input-block">
...
<%--				}--%>
          ...
          function opensjxx(personnelid){
		    ...
		    cols: [[
		        {field:'cdtname', title: '事件名称', width:200,align:"center",templet: function(d){
		    		return "<a href='#' style='text-decoration: underline;' onclick='showZbInfo(&quot;"+d.id+"&quot;);return false;'>"+d.cdtname+"</a>";
		    	}},
		...
		function openposition(personnelid){
          	layui.table.render({
			    ...
			    method:'post',
			    cols: [[
			    	{field:'positionname', title: '名称',align:"center", width:150,templet: function (item) {
			...
			           }},
			    	{field:'positiontype', title: '阵地类别', width:120} ,
			        {field:'positioncharacter', title: '阵地性质', width:120} , 
