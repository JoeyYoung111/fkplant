		...
		<div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="starttime"  id="starttime"   lay-verify="required" autocomplete="off" placeholder="请输入开始时间" class="layui-input"  lay-reqtext="请输入开始时间">
	      		</div>
	       	</div>
	  </div>
	 <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      				<input type="text"  id="endtime"  name="endtime"  id="endtime"  placeholder="请输入结束时间" class="layui-input"  lay-reqtext="请输入结束时间">
	      		</div>
	       	</div>
	     </div>
	     <div class="layui-form-item">
	       	<div class="layui-inline">
	    		<label class="layui-form-label"><font color="red" size=2>*</font>学习工作经历</label>
	    		<div class="layui-input-inline">
	      			 <textarea placeholder="请输入学习工作经历" class="layui-textarea" name="workdetails"  style="width:400px;"  lay-verify="required"></textarea>
	      		</div>
	       	</div>
	     </div> 
	...
	$(document).ready(function(){
		...
		layui.use(['form', 'laydate'], function(){
		   ...
		   form.on('submit(roleSub)', function(data){
             ...
             $("#form1").ajaxSubmit({
	              	url:		'<c:url value="/addKongPublicResume.do"/>',
	              	dataType:	'json',
	              	async:  false,
