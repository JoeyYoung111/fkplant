           ...
           var index= layui.layer.open({
			...
			layui.layer.full(index);		    
                ...
                //轨迹信息 列表显示
                 ...
                 //轨迹信息 卡口查询
                 function openTrajectoryKK(personcard_number,data_origin){
                 
                   if(data_origin==1){//卡口数据
                   
                      layui.table.render({
                 		elem:	'#trajectoryTable1',
                 		toolbar:true,
                 		url:	locat+"/searchtrajectoryKK.do?personcard_number="+personcard_number+"&data_origin="+data_origin,
                 		method:	'post',
                 		cols:[[
                 			{field:'id',type:'radio',fixed:'true',align:"center"},
                 			{field:'appear_time',title:'发现时间',align:"center"},
                 			{field:'kakou_point',title:'卡口点位',align:"center"},
                 			{field:'vehicle_number',title:'车辆号码',align:"center"},
                 			{field:'vehicle_direction',title:'车辆方向',align:"center"}
                 		]],
                 		page:	true,
                 		limit:	10
                 	});
                   }else if(data_origin==2){//2-电围数据
                       layui.table.render({
					    elem: '#trajectoryTable2',
					    toolbar: true,
					    url :   locat+"/searchtrajectoryKK.do?personcard_number="+personcard_number+"&data_origin="+data_origin,
					    method:'post',
					    cols: [[
					         {field:'id',type:'radio',fixed:'true',align:"center"},
					         {field:'telephone_number', title: '感知手机号', width:150,align:"center"},
					         {field:'appear_time', title: '感知时间', width:180,align:"center"},
					         {field:'appear_address', title: '位置',align:"center"} ,
					         {field:'insert_time', title: '推送时间',align:"center"}
					    ]],
					    page: true,
					    limit: 10
					    });
                   }else if(data_origin==3){//3-人脸识别
                        layui.table.render({
					    elem: '#trajectoryTable3',
					    toolbar: true,
					    url :   locat+"/searchtrajectoryKK.do?personcard_number="+personcard_number+"&data_origin="+data_origin,
					    method:'post',
					    cols: [[
					         ...
					         {field:'appear_time', title: '感知时间', width:180,align:"center"},
					         {field:'appear_address', title: '位置',align:"center"} ,
					         {field:'insert_time', title: '推送时间',width:180,align:"center"}
					    ]],
					    page: true,
					    limit: 10
					    });
                   }else if(data_origin==4){//4-车辆
                      layui.table.render({
					    elem: '#trajectoryTable4',
					    toolbar: true,
					    url :   locat+"/searchtrajectoryKK.do?personcard_number="+personcard_number+"&data_origin="+data_origin,
					    method:'post',
					    cols: [[
					        {field:'id',type:'radio',fixed:'true',align:"center"},
					        {field:'vehicle_number', title: '感知车牌号', width:150,align:"center"},
					        {field:'appear_time', title: '感知时间', width:180,align:"center"},
					        {field:'appear_address', title: '位置',align:"center"} ,
					        {field:'insert_time', title: '推送时间',width:180,align:"center"}
					    ]],
                   ...
                   }else if(data_origin==5){//5-旅馆
                      layui.table.render({
					    elem: '#trajectoryTable5',
					    toolbar: true,
					    url :   locat+"/searchHotel.do?ZJHM="+personcard_number,
					    method:'post',
					    cols: [[
					        {field:'lgbm', title: '旅馆编码', width:120,align:"center"},
					        {field:'lgmc', title: '旅馆名称', align:"center"},
					        {field:'rzfh', title: '入住房间', width:120,align:"center"},
					        {field:'rzsj', title: '入住时间',width:180,align:"center"} ,
					        {field:'tfsj', title: '退房时间',width:180,align:"center"}
					    ]],
					    page: true,
					    limit: 10
					    });
                   }else if(data_origin==6){//6-网吧
                      layui.table.render({
					    elem: '#trajectoryTable6',
					    toolbar: true,
					    url :   locat+"/searchInternetBar.do?CERTIFICATE_CODE="+personcard_number,
					    method:'post',
					    cols: [[
					        {field:'service_NAME', title: '网吧名称', align:"center"},
					        {field:'address', title: '网吧地址',width:250, align:"center"},
					        {field:'online_TIME', title: '上线时间', width:180,align:"center"},
					        {field:'offline_TIME', title: '下线时间',width:180,align:"center"} 
					    ]],
					    page: true,
					    limit: 10
					    });
