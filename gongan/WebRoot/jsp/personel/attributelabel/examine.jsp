	...
	<div class="layui-inline">
      ...
      <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			  <textarea placeholder="请输入不通过理由" class="layui-textarea" name="failreason"  style="width:400px;"></textarea>
	      		</div>
	       	</div>
	     </div> 
	   <br><br>   
	  ...
	  $(document).ready(function(){
		...
		layui.use(['form', 'laydate'], function(){
		   ...
		   form.on('submit(roleSub)', function(data){
             ...
             $("#form1").ajaxSubmit({
	              	url:		'<c:url value="/examineattributelabel.do"/>',
	              	dataType:	'json',
	              	async:  false,
