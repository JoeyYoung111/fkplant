...
<html>
 ...
 <div class="layui-upload" style="width:535px;margin-left:25px;">
	...
	$("#upload").on("click",function(){
		...
		window.location.href="<c:url value='/jsp/personel/template/风险人员导入模板(通用).xlsx' />";
	});
 ...
 uploadListIns=upload.render({
    elem:'#files',
  url: '<c:url value="/importPersonnelExtend.do?menuid=${param.menuid }&personlabelid=${param.personlabelid }" />',
 accept:'file',     //文件类型
 exts: 'xls|xlsx',
