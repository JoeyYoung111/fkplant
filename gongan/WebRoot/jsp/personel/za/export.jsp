...
<script type="text/javascript">
    ...
    layui.use(['form'],function(){
        ...
        form.on('submit(exportSub)', function(data){
            ...
            // ✅ 安全获取父窗口的查询条件值（避免undefined）
            var cardnumber = parent.$("#cardnumber").val() || '';
            var personname = parent.$("#personname").val() || '';
            var homeplace = parent.$("#homeplace").val() || '';
            var unitname1 = parent.$("input[name='jurisdictunit1']").val() || '';
            var policename1 = parent.$("#jurisdictpolice1").val() || '';
            var persontype = parent.$("#persontype").val() || '';
            var attributelabels = parent.$("input[name='attributelabels']").val() || '';
            ...
            var url='<c:url value="/exportPersonnelExtend.do"/>?'+
                ...
                '&homeplace='+encodeURIComponent(homeplace)+
                '&unitname1='+encodeURIComponent(unitname1)+
                '&policename1='+encodeURIComponent(policename1)+
                '&persontype='+encodeURIComponent(persontype)+
                '&attributelabels='+encodeURIComponent(attributelabels)+
