  ...
  <body>
	...
	<form class="layui-form" method="post" id="form1">
		...
		<div class="layui-form-item">
	    	...
	    	<label class="layui-form-label"  style="width:10%;">物品型号</label>
	    	<div class="layui-input-inline" style="width:20%;">
	    		<input type="text" id="goodscode" name="goodscode" lay-filter="goodscode" class="layui-input">
			</div>
	  	</div>
	  	<div class="layui-form-item">
	    	<label class="layui-form-label">案件名称</label>
	    	<div class="layui-input-inline" style="width:20%;">
	      		<input type="text" id="casename" name="casename" autocomplete="off" class="layui-input">
	    	</div>
	  	...
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline" style="width:20%;">
	    		<input type="text" class="layui-input" id="sjdate" name="sjdate" lay-verify="required" lay-verType="tips">
	    	</div>
