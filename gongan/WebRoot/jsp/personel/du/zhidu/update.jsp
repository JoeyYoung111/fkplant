					...
					<div class="layui-row" style="border-bottom: 1px solid #eee;padding: 5px;">
		              ...
		              <div class="layui-col-md5">
	                   ...
	                   <div class="layui-col-md6">
						...
						<div class="layui-col-md12">
							<div class="layui-form-item my-form-item">
								<label class="layui-form-label">同时为吸毒人员：</label>
								<div class="layui-input-block" style="width:210px;">
									<select name="personneltype">
										...
										<option value="2" <c:if test="${duextend.personneltype eq '2'}">selected</c:if>>否</option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="layui-col-md12">
							<div class="layui-form-item my-form-item">
								<label class="layui-form-label my-text-nowarp">涉毒种类：</label>
								<div class="layui-input-block">
					  ...
					  <div class="layui-col-md12"  style="margin-bottom: 30px;margin-top: 20px;margin-left: 300px;">
							<div class="layui-form-item my-form-item">
								<button type="submit" class="layui-btn" lay-submit="" lay-filter="updatedupersonel">立即提交</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（注意分类分级里的必填项）
							 </div>
						</div>
	         </div>
				</form>
				 ...
				 <div class="right-child-content layui-tab-item"><!--分类分级 -->
				  <form class="layui-form" method="post" id="formDuExtend"  onsubmit="return false;">
				         ...
				         <div class="layui-col-md5">
						  ...
						  <div class="layui-col-md12">
									<div class="layui-form-item my-form-item">
										<label class="my-form-label-br">管控现状：</label>
              ...
              formSelects.config('narcoticstype1', {
				...
				treeSelect.render({
			       ...
			       click: function(d){
			        ...
			        // 加载完成后的回调函数
			        success: function (d) {
			            var treeObj = treeSelect.zTree('jurisdictunit1');
			            if("${duextend.jurisdictunit1}"!=""&&"${duextend.jurisdictunit1}"!="0"){
		              	...
		              	success:	function(data) {
		                  	...
		                  	if(obj.flag>0){
		                     	...
		                     	setTimeout(function(){         
					        		...
					        		parent.openZhiDu();   
			 		        		//parent.layer.closeAll("iframe");  //关闭页面 必须加parent
		                   		},2000);
		                 	}else{
		                  	 	top.layer.msg(obj.msg);
		                	}
