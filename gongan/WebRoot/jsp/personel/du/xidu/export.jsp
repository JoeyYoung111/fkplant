  	...
  	<form class="layui-form" method="post" id="form1" onsubmit="return false;">
  		<table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 2.5%;margin-top: 2.5%;margin-bottom: 30px;">
			...
			<tr>
				...
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="controlstatus" name="grade" title="评定依据" lay-skin="primary">
				</td>
			</tr>
			<tr>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="controlstatusmemo" name="grade" title="其他特殊状况" lay-skin="primary">
				</td>
				<td width="30%" style="padding:5px;padding-left:20px;">
			...
			<tr>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="actualstate" name="show" title="管控现状" lay-skin="primary">
				</td>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="yesorno" name="show" title="人员现状" lay-skin="primary">
				</td>
				<td width="30%" style="padding:5px;padding-left:20px;">
		...
		layui.use(['form'],function(){
			...
			form.on('submit(exportSub)', function(data){
	         ...
	         $("input[name=show]:checked").each(function(){
	         	var p=$(this);
	         	if(p.val()=="yesorno"){
		         	showfield.push("yesorno");
		         	showtext.push("人户分离");
		         	showfield.push("yesorno2");
		         	showtext.push("双向管控");
		         	showfield.push("yesorno3");
		         	showtext.push("精神疾病患者");
		         	showfield.push("yesorno4");
		         	showtext.push("病残人员");
		         	showfield.push("yesorno5");
		         	showtext.push("三年内处罚人员");
	         	}else{
