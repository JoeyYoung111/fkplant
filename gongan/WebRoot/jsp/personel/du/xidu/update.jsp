 ...
 <body class="childrenBody layui-fluid">
		...
		<div class="layui-form  layui-row">
			...
			<div class="layui-col-md6" style="border-right: 1px solid #eee">
				<!-- 基本信息 -->
				<form class="layui-form" method="post" id="formdupersonel" onsubmit="return false;">
					...
					<div class="layui-row" style="border-bottom: 1px solid #eee;padding: 5px;">
		              ...
		              <div class="layui-col-md5">
							...
							<div class="layui-form-item my-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="personheight" lay-verify="" autocomplete="off"
										value="${personnel.personheight}" placeholder="请输入身高(单位:cm)" class="layui-input">
								</div>
							</div>
						</div>
						<div class="layui-col-md5">
	                   ...
	                   <div class="layui-col-md6">
						...
						<input type="hidden" name="homewifi" value="${personnel.homewifi}"/>
						<input type="hidden" name="homewide" value="${personnel.homewide}"/>
					 	<div class="layui-col-md6">
							<div class="layui-form-item my-form-item">
						...
						<input type="hidden" name="workwifi" value="${personnel.workwifi}"/>
						<input type="hidden" name="workwide" value="${personnel.workwide}"/>
					 	<div class="layui-col-md6">
							<div class="layui-form-item my-form-item">
						...
						<div class="layui-col-md12">
							<div class="layui-form-item my-form-item">
								<label class="layui-form-label my-text-nowarp">信息检查方式：</label>
								<div class="layui-input-block">
						...
						<div class="layui-col-md12">
							<div class="layui-form-item my-form-item">
								<label class="layui-form-label">同时为制贩毒人员：</label>
								<div class="layui-input-block" style="width:210px;">
									<select name="personneltype">
										<option value="3" <c:if test="${duextend.personneltype eq '3'}">selected</c:if>>是</option>
										<option value="1" <c:if test="${duextend.personneltype eq '1'}">selected</c:if>>否</option>
									</select>
								</div>
							</div>
						</div>
						 <div class="layui-col-md6">
							<div class="layui-form-item my-form-item">
								<label class="layui-form-label my-text-nowarp">初次吸毒时间：</label>
								<div class="layui-input-block">
									<input type="text" name="firsttime" id="firsttime"   autocomplete="off" placeholder="请输入初次吸毒时间" 
									value="${duextend.firsttime}" class="layui-input">
								</div>
							</div>
						</div>
						<div class="layui-col-md6">
							<div class="layui-form-item my-form-item">
								<label class="layui-form-label my-text-nowarp">末次处罚时间：</label>
								<div class="layui-input-block">
									<input type="text" name="lasttime" id="lasttime"   autocomplete="off" placeholder="请输入末次处罚时间" 
									value="${duextend.lasttime}" class="layui-input">
								</div>
							</div>
						</div>
						<div class="layui-col-md12">
							<div class="layui-form-item my-form-item">
								<label class="layui-form-label my-text-nowarp"><font color="red" size=2>*</font>滥用毒品种类：</label>
								<div class="layui-input-block">
					  ...
					  <div class="layui-col-md12"  style="margin-bottom: 30px;margin-top: 20px;margin-left: 300px;">
							<div class="layui-form-item my-form-item">
								<button type="submit" class="layui-btn" lay-submit="" lay-filter="updatedupersonel">立即提交</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（注意风险评估里的必填项）
							 </div>
						</div>
	         </div>
				</form>
			...
			<div class="layui-col-md6">
				...
				<div style="position: relative;">
						<div #swiperRef="" class="swiper mySwiperS  layui-tab-title btn-list swiper-container"
							...
							<div class="swiper-wrapper" style="width:85px;height: 80px;">
							    ...
							    <li class="btn btn_2 swiper-slide">风险评估</li>
								<li class="btn btn_7 swiper-slide"  onclick="openRealityShow(${personnel.id})">管控现状</li>
								<li class="btn btn_1 swiper-slide">关联信息</li>
								<li class="btn btn_5 swiper-slide"  onclick="openDuCheckRecord(${personnel.id});">检测记录</li>
				  ...
				  <form class="layui-form" method="post" id="formDuExtend"  onsubmit="return false;">
				   		<div class="layui-col-md5">
					         <div class="layui-form-item my-form-item">
									...
									<div class="layui-input-block">
									<select name="ptype" id="ptype" style="width:100px;" lay-verify="required"  lay-verType="tips">
										<option value="">==请选择==</option>
										<option  value="本地在册"  <c:if test="${duextend.ptype =='本地在册' }">selected</c:if>>本地在册</option>
	      			                    <option  value="外来前科" <c:if test="${duextend.ptype =='外来前科' }">selected</c:if>>外来前科</option>
									</select>
									</div>
								</div>
						  </div>
						  ...
						  <div class="layui-col-md5">
					         <div class="layui-form-item my-form-item">
									...
									<div class="layui-input-block">
									<select name="incontrollevel" id="incontrollevel" style="width:100px;" lay-verify="required"  lay-verType="tips"></select>
									</div>
								</div>
						  </div>
						  <br>
						  <div class="layui-col-md5">
					         <div class="layui-form-item my-form-item">
									...
									<div class="layui-input-block">
									<select name="jointcontrollevel" id="jointcontrollevel" style="width:100px;" lay-verify="required" lay-verType="tips"></select>
									</div>
								</div>
						  </div>
						 <br>
						  <div class="layui-col-md12">
							<div class="layui-form-item my-form-item">
								<label class="my-form-label-br">评定依据：</label>
								<div class="my-input-block">
								  <c:forEach items="${controlstatus}" var="row" varStatus="num">
									      <input type="checkbox" class="parent" name="controlstatus"   lay-skin="primary" value="${row.basicName}" title="${row.basicName}" >	<br>
									  </c:forEach>
									      <input type="checkbox" id="csmemoparent" class="parent" name="controlstatus"   lay-skin="primary" value="评定依据具体情况说明：" title="评定依据具体情况说明：" >
									      <input type="text" id="csmemo" lay-verify="" autocomplete="off"
										value="" placeholder="请输入评定依据具体情况说明" class="layui-input">
								</div>
							</div>
						  </div>
						 <div class="layui-col-md12">
							<div class="layui-form-item my-form-item">
								<label class="layui-form-label my-text-nowarp">其他特殊状况：</label>
								<div class="layui-input-block">
									<input type="text" name="controlstatusmemo" id="controlstatusmemo"  autocomplete="off" placeholder="请输入其他特殊状况" class="layui-input"  value="${duextend.controlstatusmemo}">
								</div>
							</div>
						</div> 
						<div class="layui-col-md12">
						...
						<div class="layui-col-md6">
							<div class="layui-form-item my-form-item">
								...
								<div class="layui-input-block">
									<select name="safetyaction" id="safetyaction">
										<option value=""<c:if test='${duextend.safetyaction eq "" }'> selected</c:if>>请选择</option>
										<option value="慰问帮扶"<c:if test='${duextend.safetyaction eq "慰问帮扶" }'> selected</c:if>>慰问帮扶</option>
										<option value="就业安置"<c:if test='${duextend.safetyaction eq "就业安置" }'> selected</c:if>>就业安置</option>
										<option value="低保救济"<c:if test='${duextend.safetyaction eq "低保救济" }'> selected</c:if>>低保救济</option>
										<option value="其他关爱措施"<c:if test='${duextend.safetyaction eq "其他关爱措施" }'> selected</c:if>>其他关爱措施</option>
									</select>
								</div>
							</div>
						</div>  
							...
							<div class="layui-col-md7">
								<div class="layui-form-item my-form-item">
									...
									<div class="layui-input-block" lay-verify="jurisdictunit1">
										<input type="text" id="jurisdictunit1" name="jurisdictunit1" value="0" lay-filter="jurisdictunit1" class="layui-input">
									</div>
								</div>
							</div>
							<div class="layui-col-md5">
				...
				<div class="right-child-content layui-tab-item"><!--现实表现 -->
							...
							<form class="layui-form" method="post" id="formRealityShow" >
								...
								<div class="layui-col-md12">
									<div class="layui-form-item my-form-item">
										<label class="my-form-label-br">管控现状
										...
										<div class="my-input-block">
										  <c:forEach items="${actualstate}" var="row" varStatus="num">
											  ...
											  <input type="checkbox" id="asmemoparent" class="parent" name="actualstate"   lay-skin="primary" value="其他特殊状态：" title="其他特殊状态：" >
										      <input type="text" id="asmemo" lay-verify="" autocomplete="off"
											value="" placeholder="请输入其他特殊状态" class="layui-input">
										</div>
									</div>
								</div>
								<div class="layui-col-md12">
									<div class="layui-form-item my-form-item">
										<label class="my-form-label-br">人员现状</label>
										<div class="my-input-block">
											<c:set var="yesorno" value=",${duextend.yesorno},"></c:set>
											<div class="layui-col-md4 layui-col-md-offset1" style="border:solid 1px #C1C1C1;">
												<label>人户分离:</label>
												<input type="radio" name="yesorno1" value="-1" title="否" checked>
												<input type="radio" name="yesorno1" value="1" title="是" <c:if test="${fn:contains(yesorno,',1,')}">checked</c:if>>
											</div>
											<div class="layui-col-md4 layui-col-md-offset1" style="border:solid 1px #C1C1C1;">
												<label>双向管控:</label>
												<input type="radio" name="yesorno2" value="-2" title="否" checked>
												<input type="radio" name="yesorno2" value="2" title="是" <c:if test="${fn:contains(yesorno,',2,')}">checked</c:if>>
											</div>
											<div class="layui-col-md4 layui-col-md-offset1" style="border:solid 1px #C1C1C1;">
												<label>精神疾病患者:</label>
												<input type="radio" name="yesorno3" value="-3" title="否" checked>
												<input type="radio" name="yesorno3" value="3" title="是" <c:if test="${fn:contains(yesorno,',3,')}">checked</c:if>>
											</div>
											<div class="layui-col-md4 layui-col-md-offset1" style="border:solid 1px #C1C1C1;">
												<label>病残人员:</label>
												<input type="radio" name="yesorno4" value="-4" title="否" checked>
												<input type="radio" name="yesorno4" value="4" title="是" <c:if test="${fn:contains(yesorno,',4,')}">checked</c:if>>
											</div>
											<div class="layui-col-md4 layui-col-md-offset1" style="border:solid 1px #C1C1C1;">
												<label>三年内处罚人员:</label>
												<input type="radio" name="yesorno5" value="-5" title="否" checked>
												<input type="radio" name="yesorno5" value="5" title="是" <c:if test="${fn:contains(yesorno,',5,')}">checked</c:if>>
											</div>
										</div>
									</div>
								</div>
		...
		<script>
			...
			var casevalue = '${duextend.casename}'.split(',');
			casevalue = turnNums(casevalue);
			//字符串转int
				...
				getDefaultPhoto();//加载默认图片
			       var checkmethods ="${personnel.checkmethod}";  //核查方式    
			         ...
			         var actualstates ="${duextend.actualstate}";  //现实表现    
			           ...
			           $('input:checkbox[name=actualstate]').each(function (i) {         
			             ...
			             if(actualstate[i]==$(this).val()){            
			               $(this).prop('checked', 'checked');
			                     ...
			                     if(actualstate[i].indexOf("其他特殊状态：")>-1&&$(this).val()=="其他特殊状态："){            
			               $(this).prop('checked', 'checked');
			               $(this).val(actualstate[i]);
			               var asmemo=actualstate[i].replace("其他特殊状态：","");
			               $("#asmemo").val(asmemo);
			                     }                
			                  }
			          ...
			          $("#asmemo").change(function(){
			          	  $("#asmemoparent").val($("#asmemoparent").prop("title")+$(this).val());
			          });
			          var controlstatus ="${duextend.controlstatus}";  //管控状态
			          if(controlstatus!=""){   
			          var controlstatus1=controlstatus.split(",");   
			           $('input:checkbox[name=controlstatus]').each(function (i) {         
			             for(i=0;i<controlstatus1.length;i++){                                             
			             if(controlstatus1[i]==$(this).val()){            
			               $(this).prop('checked', 'checked');
			                     }
			             if(controlstatus1[i].indexOf("评定依据具体情况说明：")>-1&&$(this).val()=="评定依据具体情况说明："){            
			               $(this).prop('checked', 'checked');
			               $(this).val(controlstatus1[i]);
			               var csmemo=controlstatus1[i].replace("评定依据具体情况说明：","");
			               $("#csmemo").val(csmemo);
			                     }
			          ...
			          $("#csmemo").change(function(){
			          	  $("#csmemoparent").val($("#csmemoparent").prop("title")+$(this).val());
			          });
				  $.ajax({
					type:		'POST',
              ...
              formSelects.config('narcoticstype1', {
                  ...
                  formSelects.config('narcoticstype1', {
				   ...
				   success: function(id,url, searchVal, result){      //使用远程方式的success回调
				       //设置默认值实例
				        //console.log(id);
				        var str='${duextend.narcoticstype }';
				        //console.log(str);
				        var arr=str.split(",");
				        //console.log(arr);
		           ...
		           $("#narcoticstype").val(narcoticstype);    
					...
					form.on('submit(showSub)', function(data) {
					   ...
					   var clearRisk=setInterval(function(){
						...
						var yesorno="";
						for(var i=1;i<6;i++){
							var yonval=data.field["yesorno"+i];
							if(yonval>0){
								if(yesorno!="")yesorno+=",";
								yesorno+=yonval;
							}
					      ...
					      $("#formRealityShow").ajaxSubmit({
				              	...
				              	data:		{
				              				    ...
				              				    yesorno:yesorno,
				              					id:${duextend.id },
				              					personnelid:${duextend.personnelid },
				              					menuid:${menuid}
				              				},
				              	dataType:	'json',
				              	async:  	false,
                   ...
                   layui.table.render({
					    ...
					    cols: [[
					        ...
					        {field:'checktime', title: '检查时间', width:110,align:"center",
					        	templet:function(item){return "<span style='font-weight:500;cursor:pointer;' onclick='showInfoJointCon("+item.id+");'><font color='blue'>"+item.checktime+"</font></span>";}},
