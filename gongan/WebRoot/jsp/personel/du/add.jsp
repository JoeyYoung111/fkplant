...
<html>
  ...
  <body>
	...
	<form class="layui-form" method="post" id="form1">
		...
		<input type="hidden"  name="personneltype" id="personneltype"  value="1"><!--  吸毒人员-->
		<div class="layui-form-item">
	       	<div class="layui-inline">
	    		<label class="layui-form-label"><font color="red" size=2>*</font>姓名</label>
	    		<div class="layui-input-inline">
	      			<input type="text" name="personname" lay-verify="required" autocomplete="off" placeholder="请输入人员姓名" class="layui-input"  lay-reqtext="请输入人员姓名">
	      		</div>
	       	</div>
	       	<div class="layui-inline">
	    		<label class="layui-form-label"><font color="red" size=2>*</font>身份证号</label>
	    		<div class="layui-input-inline">
	      			<input type="text" name="cardnumber" lay-verify="required" autocomplete="off" placeholder="请输入身份证号" class="layui-input"  lay-reqtext="请输入身份证号" lay-verType="tips">
	      		</div>
	       	</div>
	  </div>
	 <div class="layui-form-item">
	    ...
	    <div class="layui-form-item">
	       	<div class="layui-inline">
	    		<label class="layui-form-label">滥用毒品种类</label>
	   ...
	   <div class="layui-form-item">
	     ...
	     <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
                   	<input type="text" name="houseplace"  autocomplete="off" placeholder="请输入户籍地详址" class="layui-input"  style="width:680px;">
                </div>
	         </div> 
	     </div>  
	     <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
                    	<input type="text" name="homeplace"  autocomplete="off" placeholder="请输入现住地详址" class="layui-input"   style="width:680px;">
                </div>
	         </div> 
	     </div> 
	     <div class="layui-form-item">
