  ...
  <head>
  		...
  		<table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 2.5%;margin-top: 2.5%;margin-bottom: 30px;">
			<tr>
				<td width="60%" colspan=2>
					<strong>请选择要导出的"涉稳人员"的字段：</strong>
				</td>
				<td width="30%">
					（姓名和身份证、年龄为导出的必选属性）
				</td>
			...
			<tr>
				...
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="maintainrate1" name="personnel" title="维护率" lay-skin="primary">
				</td>
			</tr>
			<tr>
				<td width="30%" style="padding:5px;padding-left:20px;">
			...
			<tr>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="jointcontrollevel" name="grade" title="联控级别" lay-skin="primary">
				</td>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="incontrollevel" name="grade" title="在控状态" lay-skin="primary">
				</td>
				<td></td>
			</tr>
			<tr>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="typename" name="grade" title="风险人员类别" lay-skin="primary">
				</td>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="policename" name="grade" title="责任警种" lay-skin="primary">
				</td>
				<td></td>
			</tr>
			<tr>
				...
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="policephone1" name="grade" title="管辖责任民警手机" lay-skin="primary">
				</td>
			</tr>
			<tr>
				<td width="30%" style="padding:5px;padding-left:20px;">
				...
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="policephone2" name="grade" title="双管辖责任民警手机" lay-skin="primary">
				</td>
			</tr>
			<tr>
				<td width="60%" colspan=2>
			...
			<tr>
				...
				<td width="20%" style="padding-left:25px;">
					<input type="checkbox" lay-filter="riskall" title="全选" lay-skin="primary">
				</td>
			</tr>
			<tr>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="conflictdetails" name="risk" title="矛盾风险产生经过、详情" lay-skin="primary">
				</td>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="riskappeal" name="risk" title="目前风险状态及人员诉求" lay-skin="primary">
				</td>
				<td>
				</td>
			</tr>
			...
			<tr>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="lifepattern" name="show" title="日常生活规律" lay-skin="primary">
				</td>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="healthstate" name="show" title="健康状况" lay-skin="primary">
				</td>
				<td>
				</td>
			</tr>
			<tr>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="characteristic" name="show" title="性格特点" lay-skin="primary">
				</td>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="lifehabit" name="show" title="生活习惯" lay-skin="primary">
				</td>
				<td>
				</td>
			</tr>
    ...
    <script type="text/javascript">
		...
		layui.use(['form'],function(){
			...
			form.on('checkbox(riskall)',function(data){
				if(data.elem.checked){
					$("input[name=risk]").prop("checked",true);				
				}else{
					$("input[name=risk]").prop("checked",false);	
				}
				form.render();
			})
			...
			form.on('submit(exportSub)', function(data){
	         ...
	         var riskfield=[],risktext=[];
	         $("input[name=risk]:checked").each(function(){
	         	var p=$(this);
	         	riskfield.push(p.val());
	         	risktext.push(p.attr("title"));
	         });
	         ...
	         var url='<c:url value="/exportWenGrade.do"/>?'+
	         						...
	         						'&riskfield='+riskfield.join(",")+
	         						'&risktext='+risktext.join(",")+
	         						...
	         						'&personneltype='+parent.$("input[name='personneltype']").val()+
	         						'&responsiblepolice='+parent.$("input[name='responsiblepolice']").val()+
	         						'&jointcontrollevel='+(parent.$("#jointcontrollevel").val()==""?"1":parent.$("#jointcontrollevel").val())+
	         						'&incontrollevel='+parent.$("#incontrollevel").val()+
	         						'&persontype='+parent.$("#persontype").val()+
	         						'&telnumber='+parent.$("#telnumber").val()+
	         						'&color='+parent.$("#gjcolor").val()+
	         						'&menuid='+${param.menuid};
