...
<html>
  ...
  <body>
  	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  		<legend id="typeName">添加涉诉涉访经历</legend>
	</fieldset>
	...
	<div class="layui-row">
	    	...
	    	<div class="layui-col-md6">
		    	...
		    	<div class="layui-col-md9">
			    	<div class="layui-input-block">
		      			<input type="text" name="startdate" id="startdate" readonly lay-verify="required" lay-reqtext="请选择活动开始日期" autocomplete="off" placeholder="年/月/日" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	   		<div class="layui-col-md6">
		    	...
		    	<div class="layui-col-md9">	
			    	<div class="layui-input-block">
		      			<input type="text" name="enddate" id="enddate" readonly autocomplete="off" placeholder="年/月/日" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
		...
		<div class="layui-form-item" id="nodememo_show" style="display:none;">
	    	...
	    	<div class="layui-col-md11">
		    	<div class="layui-col-md11">
			    	<div class="layui-input-block">
		      			<input type="text" name="nodememo" id="nodememo" lay-verify="nodememo" autocomplete="off" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	   		...
	   		<div class="layui-col-md6">
		    	<div class="layui-col-md11">	
			    	<div class="layui-input-block" style="margin-left:-50px;">
		      			<input type="text" name="activitymemo" id="activitymemo" lay-verify="activitymemo" style="background:#efefef" readonly autocomplete="off" placeholder="备注说明" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	<div class="layui-form-item">
	    	<div class="layui-col-md6">
	   		...
	   		<div class="layui-col-md6">
		    	<div class="layui-col-md11">	
			    	<div class="layui-input-block" style="margin-left:-50px;">
		      			<input type="text" name="directionmemo" id="directionmemo" lay-verify="directionmemo" style="background:#efefef" readonly autocomplete="off" placeholder="备注说明" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	<div class="layui-form-item">
	    	<div class="layui-col-md6">
	   		...
	   		<div class="layui-col-md6">
		    	<div class="layui-col-md11">	
			    	<div class="layui-input-block" style="margin-left:-50px;">
		      			<input type="text" name="placememo" id="placememo" lay-verify="placememo" style="background:#efefef" readonly autocomplete="off" placeholder="备注说明" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
    	</div>
    	<div class="layui-form-item">
	    	<div class="layui-col-md6">
		    	...
		    	<div class="layui-col-md9">	
			    	<div class="layui-input-block">
		      			<input type="text" name="placecharacter" id="placecharacter" autocomplete="off" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	    	<div class="layui-col-md6">
	  	...
	  	<div class="layui-form-item">
	    	<div class="layui-col-md6">
	   		...
	   		<div class="layui-col-md6">
		    	<div class="layui-col-md11">	
			    	<div class="layui-input-block" style="margin-left:-50px;">
		      			<input type="text" name="formmemo" id="formmemo" lay-verify="formmemo" style="background:#efefef" readonly autocomplete="off" placeholder="备注说明" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	<div class="layui-form-item">
	    	<div class="layui-col-md6">
	   		...
	   		<div class="layui-col-md6">
		    	<div class="layui-col-md11">	
			    	<div class="layui-input-block" style="margin-left:-50px;">
		      			<input type="text" name="thingmemo" id="thingmemo" lay-verify="thingmemo" style="background:#efefef" readonly autocomplete="off" placeholder="备注说明" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-col-md11">
		    	<div class="layui-col-md11">
			    	<div class="layui-input-block">
		      			<input type="text" name="activityprocess" lay-verify="required" lay-reqText="请填写行为活动具体经过" autocomplete="off" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-col-md11">
		    	<div class="layui-col-md11">
			    	<div class="layui-input-block">
		      			<input type="text" name="acceptance" lay-verify="required" lay-reqText="请填写行为活动涉及单位登记受理情况" autocomplete="off" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	<div class="layui-form-item">
	    	<div class="layui-col-md6">
		    	...
		    	<div class="layui-col-md8">	
			    	<div class="layui-input-block">
		      			<input type="text" name="traffictype" id="traffictype" lay-verify="required" lay-reqText="请填写行为活动前往方式" class="layui-input">
			    	</div>
		    	</div>
		    	<div class="layui-col-md2" style="padding-top:5px;padding-left:15px;">
		    		<input type="hidden" id="jointcontrolid" name="jointcontrolid" value=0>
	    	...
	    	<div class="layui-col-md6">
		    	...
		    	<div class="layui-col-md9">	
			    	<div class="layui-input-block">
		      			<input type="text" name="togetherperson" id="togetherperson" autocomplete="off" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	<div class="layui-form-item">
	    	<div class="layui-col-md6">
	   		...
	   		<div class="layui-col-md6">
		    	<div class="layui-col-md11">	
			    	<div class="layui-input-block" style="margin-left:-50px;">
		      			<input type="text" name="staymemo" id="staymemo" lay-verify="staymemo" style="background:#efefef" readonly autocomplete="off" placeholder="备注说明" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	<div id="stay_show" style="display:none;">
	  		<div class="layui-form-item">
		    	<div class="layui-col-md6">
			    	...
			    	<div class="layui-col-md9">
				    	<div class="layui-input-block">
			      			<input type="text" name="hotelintime" id="hotelintime" readonly lay-verify="hotelintime" autocomplete="off" placeholder="年/月/日" class="layui-input">
				    	</div>
			    	</div>
		    	</div>
		   		<div class="layui-col-md6">
			    	...
			    	<div class="layui-col-md9">	
				    	<div class="layui-input-block">
			      			<input type="text" name="hotelouttime" id="hotelouttime" readonly lay-verify="hotelouttime" autocomplete="off" placeholder="年/月/日" class="layui-input">
				    	</div>
			    	</div>
		    	</div>
		  	</div>
	  		<div class="layui-form-item">
		    	<div class="layui-col-md6">
			    	...
			    	<div class="layui-col-md9">
				    	<div class="layui-input-block">
			      			<input type="text" name="hotelname" lay-verify="hotelname" autocomplete="off" class="layui-input">
				    	</div>
			    	</div>
		    	</div>
		   		<div class="layui-col-md6">
			    	...
			    	<div class="layui-col-md9">	
				    	<div class="layui-input-block">
			      			<input type="text" name="hotelroom" lay-verify="hotelroom" autocomplete="off" class="layui-input">
				    	</div>
			    	</div>
		    	</div>
		  	</div>
	  		<div class="layui-form-item">
		    	<div class="layui-col-md6">
			    	...
			    	<div class="layui-col-md9">
				    	<div class="layui-input-block">
			      			<input type="text" name="hotelcode" lay-verify="hotelcode" autocomplete="off" class="layui-input">
				    	</div>
			    	</div>
		    	</div>
		   		<div class="layui-col-md6">
			    	...
			    	<div class="layui-col-md9">	
				    	<div class="layui-input-block">
			      			<input type="text" name="hoteladdress" lay-verify="hoteladdress" autocomplete="off" class="layui-input">
				    	</div>
			    	</div>
		    	</div>
		  	</div>
	  	...
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-col-md11">
		    	<div class="layui-col-md11">
			    	<div class="layui-input-block">
		      			<input type="text" name="findunit" lay-verify="required" lay-reqText="请填写行为活动现场发现单位" autocomplete="off" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-col-md11">
		    	<div class="layui-col-md11">
			    	<div class="layui-input-block">
		      			<input type="text" name="vehiclememo" autocomplete="off" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	<div id="returntype_show" class="layui-form-item" style="display:none;">
	    	<div class="layui-col-md6">
		    	...
		    	<div class="layui-col-md9">
			    	<div class="layui-input-block">
		      			<input type="text" name="powerunit" lay-verify="powerunit" autocomplete="off" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	   		<div class="layui-col-md6">
		    	...
		    	<div class="layui-col-md9">	
			    	<div class="layui-input-block">
		      			<input type="text" name="personstate" lay-verify="personstate" autocomplete="off" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
		    	...
		    	<div class="layui-col-md9">
			    	<div class="layui-input-block" lay-verify="returncollect">
		      			<select name="returncollect" id="returncollect" lay-filter="returncollect">
			      			<option value>==请选择==</option>
			      			<option value="已标采">已标采</option>
			      			<option value="采手机">采手机</option>
			      			<option value="未采集">未采集</option>
			      			<option value="无采集条件">无采集条件</option>
						</select>
			    	</div>
		    	</div>
	    	</div>
		    	...
		    	<div class="layui-col-md9">
			    	<div class="layui-input-block" lay-verify="returnpunish">
		      			<select name="returnpunish" id="returnpunish" lay-filter="returnpunish">
			      			<option value>==请选择==</option>
			      			<option value="教育训诫">教育训诫</option>
			      			<option value="行政处罚">行政处罚</option>
			      			<option value="刑事强制">刑事强制</option>
	  	...
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-col-md11">
		    	<div class="layui-col-md11">
			    	<div class="layui-input-block">
		      			<textarea class="layui-textarea" rows=2 name="punishcontent"></textarea>
			    	</div>
		    	</div>
	    	</div>
	  	</div>
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-col-md11">
		    	<div class="layui-col-md11">
			    	<div class="layui-input-block">
		      			<input type="text" name="unitreply" autocomplete="off" class="layui-input">
			    	</div>
		    	</div>
	    	</div>
	  	</div>
		  ...
		  form.on('submit(visitSub)', function(data){
	         ...
	         var clearVisit=setInterval(function(){
	         	if(admonishfileBool&&attachmentsBool){
			         $("#form1").ajaxSubmit({
			              	url:		'<c:url value="/addWenVisit.do"/>',
			              	data:		{
			              					admonishfile:admonishfile,
			 ...
			 $("#connect").click(function(){
				...
				var index = layui.layer.open({
					...
					content : locat+'/jsp/personel/wen/visit/connect.jsp?personnelid='+personnelid+'&jointcontrolid='+jointcontrolid+'&wenvisitid=-1',
					area: ['700', '650px'],
					maxmin: true,
