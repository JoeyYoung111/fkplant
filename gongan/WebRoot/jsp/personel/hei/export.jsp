  		...
  		<table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 2.5%;margin-top: 2.5%;margin-bottom: 30px;">
			<tr>
				<td width="60%" colspan=2>
					<strong>请选择要导出的"涉黑人员"的字段：</strong>
				</td>
				<td width="30%">
					（姓名和身份证、年龄为导出的必选属性）
				</td>
			...
			<tr>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="incontrolleve" name="grade" title="联控状态" lay-skin="primary">
				</td>
				<td width="30%" style="padding:5px;padding-left:20px;">
					<input type="checkbox" value="editablename" name="grade" title="可查看人员" lay-skin="primary">
				</td>
				<td></td>
			</tr>
		   <tr>
    ...
    <script type="text/javascript">
		...
		layui.use(['form'],function(){
			...
			form.on('submit(exportSub)', function(data){
	         ...
	         var url='<c:url value="/exportHeiPersonnel.do"/>?'+
	         						...
	         						'&nation='+parent.$("#nation").val()+
	         						'&homeplace='+parent.$("#homeplace").val()+
	         					    '&workplace='+parent.$("#workplace").val()+
	         					    '&homepolice='+parent.$("#homepolice").val()+
	         					    '&workpolice='+parent.$("#workpolice").val()+
	         						'&incontrolleve='+parent.$("#incontrolleve").val()+
	         						'&menuid='+${param.menuid};
