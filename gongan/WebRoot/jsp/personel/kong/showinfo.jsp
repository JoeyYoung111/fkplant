...
<%--							</tr>--%>
			...
			<div class="layui-row" style="padding: 1px;">
					<table class="layui-table" lay-even>
						...
						<thead>
							<tr>
								<th colspan="4" class="layui-bg-blue layui-font-16 my-text-nowarp">指派信息</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="text-align-r my-text-nowarp">管辖单位(民警)：</td>
								<td colspan="3">${personnel.jurisdictunit}(${personnel.jurisdictpolice})</td>
								
							</tr>
							<tr>
								<td class="text-align-r my-text-nowarp">双管辖单位(民警)：</td>
								<td colspan="3">${personnel.policephone}(${personnel.incontrolleve})</td>
					...
					<table class="layui-table" lay-even>
						...
						<thead>
							<tr>
								<th colspan="4" class="layui-bg-blue layui-font-16 my-text-nowarp">分色管控信息</th>
							</tr>
						</thead>
						<tbody>
						  <tr>
								<td class="text-align-r my-text-nowarp">籍贯：</td>
								<td>${kongextend.nativeplace}</td>
								<td class="text-align-r my-text-nowarp">是否国家、省平台标签人员：</td>
								<td>${kongextend.contractperson}</td>
							</tr>
							<tr>
								<td class="text-align-r my-text-nowarp">联控级别：</td>
								<td>
								    <c:if test="${kongextend.jointtype == '1' }">红色</c:if>
								    <c:if test="${kongextend.jointtype == '2' }">橙色</c:if>
								    <c:if test="${kongextend.jointtype == '3' }">黄色</c:if>
								    <c:if test="${kongextend.jointtype == '4' }">蓝色</c:if>
								</td>
								<td class="text-align-r my-text-nowarp">在控级别：</td>
								<td>${kongextend.incontrollevel}</td>
							</tr>
							<tr>
								<td class="text-align-r my-text-nowarp">来本地时间：</td>
								<td>${kongextend.cometime}</td>
								<td class="text-align-r my-text-nowarp">拟离开时间：</td>
								<td>${kongextend.leavetime}</td>
							</tr>
							<tr>
								<td class="text-align-r my-text-nowarp">来本地事由：</td>
								<td >${kongextend.comereason}</td>
								<td class="text-align-r my-text-nowarp">从事行业：</td>
								<td >${kongextend.engagedwork}</td>
							</tr>
							<tr>
								<td class="text-align-r my-text-nowarp">身份：</td>
								<td>${kongextend.identity}</td>
								<td class="text-align-r my-text-nowarp">服务处所：</td>
								<td>${kongextend.serviceplace}</td>
							</tr>
							<tr>
								<td class="text-align-r my-text-nowarp">分类：</td>
								<td>${kongextend.classify}</td>
								<td class="text-align-r my-text-nowarp">分类明细：</td>
								<td>${kongextend.classifydetail}</td>
							</tr>
				...
				<%--<ul class="layui-tab-title btn-list" style="margin:0px; padding:0px;">
					...
					<div style="position: relative;">
						<div #swiperRef="" class="swiper mySwiperS  layui-tab-title btn-list swiper-container"
							...
							<div class="swiper-wrapper" style="width:85px;height: 80px;">
								...
								<li class="btn btn_5 swiper-slide"  onclick="openKongExtend(${personnel.id});">可疑特征</li><!--  背景审查、可疑特征 -->
								...
								<li class="btn btn_2 swiper-slide" onclick="openKongControlPower(${personnel.id});">管控力量</li><!--管控力量-->
								<li class="btn btn_7 swiper-slide" onclick="openWorkandlive(${personnel.id});">工作地,居住地</li><!--工作地,居住地 -->
					...
					<div class="right-child-content layui-tab-item layui-show"><!--人员属性标签 -->
						...
						<div class="right-child-content layui-tab-item">
								<div class="layui-col-md12">
									<div class="layui-form-item my-form-item">
										...
										<div class="my-input-block">
										   	<textarea  class="layui-textarea"  readonly	id="religion" name="religion">${kongextend.religion}</textarea>
										</div>
									</div>
								</div>
								...
								<div class="layui-col-md12">
									<div class="layui-form-item my-form-item">
										...
										<div class="my-input-block">
											<textarea  class="layui-textarea"  readonly	id="suspiciousthing" name="suspiciousthing">${kongextend.suspiciousthing}</textarea>
										</div>
									</div>
								</div>
								<!-- 多文件上传 -->
								<div class="layui-col-md12">
								<div class="layui-form-item my-form-item">
										<label class="my-form-label-br">体貌特征照片：</label>
									</div>
								</div>
								<div class="layui-col-md12">
									<div class="layui-form-item my-form-item" style="padding: 5px;"  id="risk-view-fileList">
								    </div>
								</div>
						</div>
						...
						<div class="right-child-content layui-tab-item">
							...
							<div class="layui-tab-content" >
							     <div class="layui-tab-item layui-show">
							           <table class="layui-hide" id="kongcontrolpowerTable1" lay-filter="kongcontrolpowerTable1"></table><!--工作地、居住地 -->
							     </div>
							     <div class="layui-tab-item">
