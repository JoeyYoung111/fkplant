		...
		<div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="appellation"  id="appellation"   lay-verify="required" autocomplete="off" placeholder="请输入称谓" class="layui-input"  lay-reqtext="请输入称谓">
	      		</div>
	       	</div>
	  </div>
	 <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      				<input type="text"  id="relationname"  name="relationname"  lay-verify="required"   placeholder="请输入姓名" class="layui-input"  lay-reqtext="请输入姓名">
	      		</div>
	       	</div>
	     </div>
	     <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      				<input type="text"  id="politicalposition"  name="politicalposition"   placeholder="请输入政治表现" class="layui-input" >
	      		</div>
	       	</div>
	     </div>
	     <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			 <textarea placeholder="请输入现在工作地点、部门及职务" class="layui-textarea" name="workdetails"  style="width:400px;"></textarea>
	      		</div>
	       	</div>
	     </div> 
	...
	$(document).ready(function(){
		...
		layui.use(['form', 'laydate'], function(){
		   ...
		   form.on('submit(roleSub)', function(data){
             ...
             $("#form1").ajaxSubmit({
	              	url:		'<c:url value="/addKongPublicRelation.do"/>',
	              	dataType:	'json',
	              	async:  false,
