		...
		<div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			...
	      			placeholder="请选择管控时间" class="layui-input"  lay-reqtext="请选择管控时间"  >
	      		</div>
	       	</div>
	  </div>
	  <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			 <textarea placeholder="请输入内容" class="layui-textarea" name="controlcontent" style="width:500px;height:200px;"></textarea>
	      		</div>
	       	</div>
	     </div> 
