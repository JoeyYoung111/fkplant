		 ...
		 <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="opentime" id="opentime"  autocomplete="off" placeholder="请输入开户时间" class="layui-input" >
	       	</div>
	     </div>
	     </div>
		<div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="bankaccount" lay-verify="required" autocomplete="off" placeholder="请输入银行账号" class="layui-input"  lay-reqtext="请输入银行账号">
	      		</div>
	       	</div>
	  </div>
	 <div class="layui-form-item">
	     ...
	     <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="openbank"  autocomplete="off" placeholder="请输入开户行" class="layui-input" >
	      		</div>
	       	</div>
	     </div> 
	   <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="openaddress"  autocomplete="off" placeholder="请输入开户地址" class="layui-input" >
	      		</div>
	       	</div>
	     </div> 
	...
	$(document).ready(function(){
		...
		layui.use(['form', 'laydate'], function(){
		   ...
		   form.on('submit(roleSub)', function(data){
             ...
             $("#form1").ajaxSubmit({
	              	url:		'<c:url value="/addrelationbank.do"/>',
	              	dataType:	'json',
	              	async:  false,
	              	success:	function(data) {
	                  	var obj = eval('(' + data + ')');
