	...
	<form class="layui-form" method="post" id="form1">
	 ...
	 <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="inventedname"  autocomplete="off" placeholder="请输入身份昵称" class="layui-input" >
	      		</div>
	       	</div>
	     </div>
	     <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="accountid"  autocomplete="off" placeholder="请输入账号ID" class="layui-input" >
	      		</div>
	       	</div>
	     </div>
	     <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="wechat"  autocomplete="off" placeholder="请输入微信号" class="layui-input" >
	      		</div>
	       	</div>
	     </div>  
	      <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="telnumber"  autocomplete="off" placeholder="请输入注册手机号" class="layui-input" >
	      		</div>
	       	</div>
	     </div>  
	   <div class="layui-form-item">
	...
	$(document).ready(function(){
		...
		layui.use(['form', 'laydate'], function(){
		   ...
		   form.on('submit(roleSub)', function(data){
             ...
             $("#form1").ajaxSubmit({
	              	url:		'<c:url value="/addrelationidentity.do"/>',
	              	dataType:	'json',
	              	async:  false,
	              	success:	function(data) {
	                  	var obj = eval('(' + data + ')');
