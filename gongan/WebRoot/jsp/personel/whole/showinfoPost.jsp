			...
			<div class="layui-col-md6" style="border-right: 1px solid #eee">
				...
				<div class="layui-row" style="padding: 1px;">
					<table class="layui-table" lay-even>
						...
						<thead>
							<tr>
								<th colspan="6" class="layui-bg-blue layui-font-16 my-text-nowarp">管辖派出所信息</th>
							</tr>
						</thead>
						<tbody>
					...
					--%><div style="position: relative;">
						<div #swiperRef="" class="swiper mySwiperS  layui-tab-title btn-list swiper-container"
							...
							<div class="swiper-wrapper" style="width:85px;height: 80px;">
								...
								<li class="btn btn_3 swiper-slide" onclick="openSocialRelationsPost(${personnel.id});">社会关系</li>
...
<%--				}--%>
          ...
          //社会关系 列表显示
                 function  openSocialRelationsPost(personnelid){
                   layui.table.render({
					    elem: '#socialrelationsTable',
					    toolbar: true,
					    defaultToolbar: ['filter', 'exports', 'print'],
					    url :   locat+"/searchsocialrelationsbypost.post?personnelid="+personnelid,
					    method:'post',
					    ...
					    cols: [[
					        ...
					        {field:'relationtype', title: '关系类别', width:120,align:"center",templet: function (item) {
								   return "<span style='font-weight:500;cursor:pointer;' onclick='showinfoSocialrelationspost("+item.id+");'><font color='blue'>"+item.relationtype+"</font></span>";
		                    }},
...
//					        {field: 'right', title: '操作', toolbar: '#socialrelationsbar',width:50,align:"center"} 
          ...
          function showinfoSocialrelationspost(id){
			   		var menuid=$("#menuid").val();
			   		var index = layui.layer.open({
						title : "社会关系详情",
						type : 2,  //0（信息框，默认）1（页面层）2（iframe层）3（加载层）4（tips层）
						content : locat+'/getsocialrelationsbyidbypost.post?id='+id+'&menuid='+menuid+'&page=showinfo',
						area: ['800', '600px'],
						maxmin: true,
						success : function(layero, index){
							setTimeout(function(){
