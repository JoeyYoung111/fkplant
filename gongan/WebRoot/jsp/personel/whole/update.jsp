...
<%--					<input type="hidden"  name="personlabelname"id="personlabelname" value=${personnel.personlabelname }>--%>
				...
				<!-- 分级分类信息 -->
					<div class="layui-row" style="padding: 15px;">
						...
						<div class="layui-col-md4 layui-col-md-offset6" style="margin-bottom: 30px;margin-top: 30px;">
							<div class="layui-form-item my-form-item">
							<button type="submit" class="layui-btn" lay-submit="" lay-filter="updateWholePersonnel">立即提交</button>
	...
	<%--						<button type="button" class="layui-btn layui-btn-sm layui-btn-primary">&nbsp;重置&nbsp;</button>--%>
											...
											<div id="label" style="height: 680px;display:none;">
												...
												<div class="layui-form-item my-form-item">
													...
													<div class="my-input-block">
														<textarea placeholder="请输入标签信息内容" class="layui-textarea"
												...
												<div class="layui-form-item my-form-item">
													...
													<div class="my-input-block">
														<textarea placeholder="请输入备注信息内容" class="layui-textarea"
		...
		<script>
			...
			layui.use(['element', 'form', 'upload','jquery','selectInput','treeSelect','table'], function() {
				...
				form.on('submit(updateWholePersonnel)', function(data) {
					var url='<c:url value="/updateWholePersonnel.do"/>?validflag=1';
...
<%--			    type: 'get',  //设置了长度    --%>
<%--			    selected: [${personnel.attributelabels}],//默认值            --%>
<%--			    max: 100,//最多选中个数，默认5            --%>
...
<%--				else{--%>
<%--					var personlabels="${personnel.labelsql}".split(",");--%>
<%--					var titles="${personnel.memo}".split(",");--%>
