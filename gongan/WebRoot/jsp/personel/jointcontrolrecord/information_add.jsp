	...
	<div class="layui-row">
		    ...
		    <div class="layui-col-md11">
		    	<div class="layui-col-md11">
			    	<div class="layui-input-block">
		      			<input type="text" name="submitunitid" id="submitunitid" class="layui-input" lay-verify="required"  lay-verType="tips" lay-reqtext="请选择主报送单位" autocomplete="off"/>
		...
		<div class="layui-form-item">
			...
			<div class="layui-col-md11">
		    	...
		    	<div class="layui-col-md1">	
		    		...
		    		<button type="button" class="layui-btn layui-btn-sm" onclick="openUnits();"><i class="layui-icon layui-icon-add-1"></i>选 择 单 位</button>
		    	</div>
		    </div>
		</div>
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-col-md11">
		    	<div class="layui-col-md11">
			    	<div class="layui-input-block">
			    		<select name="infosource" id="infosource" lay-filter="infosource"   lay-verify="required"  lay-verType="tips"></select>
		      		</div>
		    	</div>
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-col-md11">
				<div class="layui-col-md11">
					<div class="layui-input-block">
						<textarea id="infocontent" class="layui-textarea">${jointcontrolrecord.information}</textarea>
					</div>
				</div>
			</div>
		</div>
	    		...
	    		<div class="layui-col-md11">
		    		...
		    		<div class="layui-input-block">
						...
						<table class="layui-table" lay-size="sm" lay-filter="demoEvent">
							...
							<tbody id="table-body">
								  <c:forEach items="${infojointperson}" var="row" varStatus="num">
							     <tr>
									<td>
										<a href="javascript:;" class="bg-ctrl2 my-btn-a js_table_edit_customer_reduce" ></a>
									</td>
									<td>
										<input type="text" id="jointCardNumber${num.index}" class="layui-input" lay-verify="required" onblur="getpersonelname(${num.index});"  value="${row.jointCardNumber}"/>
									</td>
									<td>
										<input type="text" id="jointName${num.index}" class="layui-input" lay-verify="required" value="${row.jointName}"/>
									</td>
									<td>
										<input type="text" id="jointTelephone${num.index}" class="layui-input"  value="${row.jointTelephone}"/>
									</td>
									<td>
										<input type="text" id="jointHousePlace${num.index}" class="layui-input" value="${row.jointHousePlace}"/>
									</td>
									<td>
										<input type="text" id="jointNickName${num.index}" class="layui-input"/>
									</td>
									<td>
										<input type="text" id="jointWechat${num.index}" class="layui-input" />
									</td>
									<td>
										<input type="text" id="jointQQ${num.index}" class="layui-input"/>
									</td>
									<td>
										<input type="text" id="jointHomePlace${num.index}" class="layui-input"/>
									</td>
								</tr>
							</c:forEach>
	...
	$.ajax({
		...
		success:	function(data){
			...
			$("select[name^=infosource]").html(options);
			 $("#infosource").val("${jointcontrolrecord.jointorigin}");
		}
	});
}
...
layui.use(['form','upload','zTreeSelectM','layedit','treeSelect','zTreeSelectM'],function(){
	...
	$(".js_table_edit_customer_add").click(function (){
		...
		var str = '<tr><td><a href="javascript:;" class="bg-ctrl2 my-btn-a js_table_edit_customer_reduce" ></a></td>'
			+ '<td><input type="text" id="jointCardNumber'+i+'" class="layui-input" lay-verify="required"  onblur="getpersonelname('+i+');"></td>'
		    + '<td><input type="text" id="jointName'+i+'" class="layui-input"  lay-verify="required" ></td>'
