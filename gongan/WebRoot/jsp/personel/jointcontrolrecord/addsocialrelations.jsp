  ...
  <body>
   <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
	...
	<form class="layui-form" method="post" id="form1">
		...
		<input type="hidden"  name="indexnum" id="indexnum"  value=${param.indexnum}></input>
		<div class="layui-form-item">
	      ...
	      <div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<select id="relationtype"  name="relationtype" style="width:170px;" lay-verify="required" lay-verType="tips"></select>
	      		</div>
	       	</div>
	     </div>
	     <div class="layui-form-item">
	       	<div class="layui-inline">
	    		<label class="layui-form-label">关系称谓</label>
	    		<div class="layui-input-inline">
	      			<select id="appellation"  name="appellation" style="width:170px;" lay-verify="required" lay-verType="tips"></select>
	      		</div>
	       	</div>
	       <div class="layui-inline">
	    		<label class="layui-form-label">身份证号</label>
	    		<div class="layui-input-inline">
	      			<input type="text" name="cardnumber" id="cardnumber"  autocomplete="off" placeholder="请输入身份照号" class="layui-input" lay-verify="required"  value="${param.cardnumber}">
	      		</div>
	       	</div>
	     </div> 
	    <div class="layui-form-item">
	       ...
	       <div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="homeplace"  autocomplete="off" placeholder="请输入现居地" class="layui-input" >
	      		</div>
	       	</div>
	     </div> 
	      <div class="layui-form-item">
	       	<div class="layui-inline">
	    		...
	    		<div class="layui-input-inline">
	      			<input type="text" name="workplace"  autocomplete="off" placeholder="请输入工作单位" class="layui-input" >
	      		</div>
	       	</div>
	       <div class="layui-inline">
...
$(function(){if('main'== locat[3]){locat =  locat[0]+'//'+locat[2];}else{locat =  locat[0]+'//'+locat[2]+'/'+locat[3];};});
	$(document).ready(function(){
	    $.ajax({
		 ...
		 $.ajax({
				type:		'POST',
				 url:		'<c:url value="/getBMByTypeToJSON1.do" />?basicType='+68, 
				 dataType:	'json',
				 async :      false,
				 success:	function(data){					  
				      var options = '<option value="">--请选择---</option>' + fillOption(data);
			 ...
			 $.ajax({
				type:		'POST',
				 url:		'<c:url value="/getBMByTypeToJSON1.do" />?basicType='+69, 
				 dataType:	'json',
				 async :      false,
				 success:	function(data){					  
				      var options = '<option value="">--请选择---</option>' + fillOption(data);
	              	...
	              	success:	function(data) {
	                  	...
	                  	if(obj.flag>0){
	                     	...
	                     	setTimeout(function(){         
	                     	    ...
	                     	    var i=${param.indexnum};
				        	    parent.document.getElementById("togethername"+i).value=$("#personname").val();
