...
<html>
  ...
  <body>
  	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  		<legend id="typeName"><button type="button" class="layui-btn" id="upload"><i class="layui-icon">&#xe601;</i>下 载 模 板</button></legend>
	</fieldset>
 ...
 <div class="layui-upload" style="width:535px;margin-left:25px;">
	...
	$("#upload").on("click",function(){
		...
		switch(${param.trailtype}){
			case 1:
				window.location.href="<c:url value='/jsp/trail/template/全国银行信息导入模板.xlsx' />";
				break;
			case 2:
				window.location.href="<c:url value='/jsp/trail/template/全国铁路信息导入模板.xlsx' />";
				break;
			case 3:
				window.location.href="<c:url value='/jsp/trail/template/全国民航离港信息导入模板.xlsx' />";
				break;
			case 4:
				window.location.href="<c:url value='/jsp/trail/template/全国民航订票信息导入模板.xlsx' />";
				break;
			case 5:
				window.location.href="<c:url value='/jsp/trail/template/全国机动车违章信息导入模板.xlsx' />";
				break;
			case 6:
				window.location.href="<c:url value='/jsp/trail/template/全国出入境信息导入模板.xlsx' />";
				break;
		}
	});
 ...
 uploadListIns=upload.render({
    elem:'#files',
  url: '<c:url value="/importTrailInformation.do" />?trailtype='+${param.trailtype},
 accept:'file',     //文件类型
 exts: 'xls|xlsx',
 multiple:true,     //多文件上传
