...
function(c,a,b,f){(!a||!d.isHidden(c,a))&&s.apply(e,arguments)};var t=e.repairParentChkClassWithSelf;if(t)e.repairParentChkClassWithSelf=function(c,a){(!a||!d.isHidden(c,a))&&t.apply(e,arguments)}})(jQuery);
  ...
  TreeSelect.prototype.render = function (options) {
    var elem = options.elem,
      ...
      TREE_OBJ = undefined,
      TREE_INPUT_ID = 'treeSelect-input-' + elem.substring(1),
      TREE_INPUT_CLASS = 'layui-treeselect',
      TREE_SELECT_ID = 'layui-treeSelect-' + elem.substring(1),
      TREE_SELECT_CLASS = 'layui-treeSelect',
      TREE_SELECT_TITLE_ID = 'layui-select-title-' + elem.substring(1),
      TREE_SELECT_TITLE_CLASS = 'layui-select-title',
      TREE_SELECT_BODY_ID = 'layui-treeSelect-body-' + elem.substring(1),
    ...
    var a = {
      ...
      input: function () {
        ...
        var selectHtml = '<div class="' + TREE_SELECT_CLASS + ' layui-unselect layui-form-select" id="' + TREE_SELECT_ID + '">' +
          ...
          ' <input type="text" id="' + TREE_INPUT_ID + '" placeholder="' + placeholder + '" value="" ' + readonly + ' class="layui-input layui-unselect" autocomplete="off">' +
      ...
      configStyle: function () {
        ...
        if (style == undefined || style.folder == undefined || !style.folder.enable) {
		  ...
		  $('#' + TREE_SELECT_ID).find('li span.button.ico_docu').hide();
        }
      },
  ...
  TreeSelect.prototype.hideIcon = function () {
	  $('.layui-treeSelect-body').find('li span.button.ico_open').hide();
	  $('.layui-treeSelect-body').find('li span.button.ico_close').hide();
	  $('.layui-treeSelect-body').find('li span.button.ico_docu').hide();
  };
