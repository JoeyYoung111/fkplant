...
layui.define(['jquery', 'layer'], function(exports){
	...
	var obj = function(config){
		...
		this.createOption = function(){
			...
			var reqtext=c.reqtext==''?'':'lay-reqtext="'+c.reqtext+'" ';
			var reqdiv=c.reqdiv==''?'':'lay-reqdiv="'+c.reqdiv+'" ';
            var html = '<link rel=\"stylesheet\" href=\"./layui/lay/modules/zTreeSelectM/zTreeSelectM.css\">\n';            
	            html += '<link rel=\"stylesheet\" href=\"./layui/lay/modules/zTreeSelectM/zTree_v3/css/zTreeStyle/zTreeStyle.css\">\n';
	            html += '<script type=\"text/javascript\" src=\"./layui/lay/modules/zTreeSelectM/zTree_v3/js/jquery.ztree.all.min.js\"></script>\n';
				html +=	'<div class="layui-unselect layui-form-select">';
	            html +=		'<div class="layui-select-title" style="display:none;">';
				html +=			'<input '+verify+reqtext+reqdiv+'name="'+inputName+'" type="text" readonly="" class="layui-input layui-unselect">';
				html +=		'</div>';
    ...
    obj.prototype.render = function(){
		...
		if(c.json!=''){
			o.config.data = c.json;
		}
		else if(c.json==''&&Object.prototype.toString.call(c.data)!='[object Array]'){
