...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<c:url value="/security-dist/css/maodun.css"/>"/>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$("#mainbody").load("<c:url value='/getMaodunSecurityDist.post'/>?menuid=${param.menuid}");
		});
	</script>
</head>
<body class="body">
