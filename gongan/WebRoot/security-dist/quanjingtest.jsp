...
<head>
  ...
  <title>江阴市公安局风控平台全景数据看板</title>

  <link rel="stylesheet" type="text/css" href="./layui/css/layui.css"/>
  <link rel="stylesheet" type="text/css" href="./css/root.css"/>
  <link rel="stylesheet" type="text/css" href="./css/quanjing.css"/>
</head>
<body class="body">
  <div class="container">
    <!-- 全屏、时间 -->
                ...
                <div class="table">
                  <div class="thead">
                    <div class="tr">
                      ...
                      <div class="th">所有人</div>
                      <div class="th">数量</div>
                    </div>
                  </div>
                  <div class="tbody">
                    <div class="tr">
                      <div class="td">00001</div>
                      <div class="td">老鼠药</div>
                      <div class="td">张三</div>
                      <div class="td">670袋</div>
                    </div>
                    <div class="tr">
                      <div class="td">00002</div>
                      <div class="td">爆炸物品</div>
                      <div class="td">李四</div>
                      <div class="td">30kg</div>
                    </div>
                    <div class="tr">
                      <div class="td">00003</div>
                      <div class="td">剧毒物品</div>
                      <div class="td">王五</div>
                      <div class="td">218.08克</div>
                    </div>
                    <div class="tr">
                      <div class="td">00004</div>
                      <div class="td">老鼠药</div>
                      <div class="td">张三</div>
                      <div class="td">670袋</div>
                    </div>
                    <div class="tr">
                      <div class="td">00005</div>
                      <div class="td">爆炸物品</div>
                      <div class="td">李四</div>
                      <div class="td">30kg</div>
                    </div>
                    <div class="tr">
                      <div class="td">00006</div>
                      <div class="td">剧毒物品</div>
                      <div class="td">王五</div>
                      <div class="td">218.08克</div>
                    </div>
                    <div class="tr">
                      <div class="td">00007</div>
                      <div class="td">老鼠药</div>
                      <div class="td">张三</div>
                      <div class="td">670袋</div>
                    </div>
                    <div class="tr">
                      <div class="td">00008</div>
                      <div class="td">爆炸物品</div>
                      <div class="td">李四</div>
                      <div class="td">30kg</div>
                    </div>
                    <div class="tr">
                      <div class="td">00009</div>
                      <div class="td">剧毒物品</div>
                      <div class="td">王五</div>
                      <div class="td">218.08克</div>
                    </div>
  ...
  <script src="./data/全景数据看板.js" type="text/javascript"></script>
    ...
    var chartOptions = {
            ...
            data: [
              {
                ...
                value: [
                  2091, 127, 207, 656, 65, 64, 14, 79, 150, 6, 153
                ]
              }
            ]
          }
          ...
          formatter: function (params) {
            ...
            if (list && list.length) {
              for (let i = 0; i < list.length; i++) {
                var cur = list[i]
				console.log(cur)
                str += '<p style="margin-bottom: 5px;">${cur.name}</p>'
                str += '<p>风险人员：${cur.renyuan}人</p>'
                str += '<p style="margin-bottom: 5px;"><span style="margin-right: 10px;">涉稳：${cur.wen}人</span><span style="margin-right: 10px;">涉恐：${cur.kong}人</span><span style="margin-right: 10px;">涉毒：${cur.du}人</span></p>'
                str += '<p>风险矛盾：${cur.maodun}人</p>'
                str += '<p style="margin-bottom: 15px;"><span style="margin-right: 10px;">已化解：${cur.huajie}人</span><span style="margin-right: 10px;">已钝化：${cur.dunhua}人</span><span style="margin-right: 10px;">处置中：${cur.chuzhi}人</span></p>'
              }
            }
        ...
        xAxis: [
          {
            ...
            data: ['君山所', '城中所', '要塞所', '西郊所', '滨江所', '城东所', '云亭所', '南闸所', '利港所', '夏港所', '申港所', '璜土所', '青阳所']
          },
        ],
        yAxis: [
          {
        ...
        series: [
          {
            ...
            type: 'bar',
            data: [
              835, 753, 1324, 602, 730, 870, 613, 810, 916, 502, 578, 931, 830
            ]
          },
          {
            name: '矛盾事件',
            type: 'bar',
            data: [
              67, 213, 238, 125, 49, 119, 205, 167, 94, 165, 87, 154, 182
            ]
          },
          {
            name: '占比',
      ...
      option6: {
        ...
        yAxis: {
          ...
          data: _extractData(company_whole, 'text')//['生产', '经营', '运输', '使用', '仓储']
        },
        series: [
          {
            type: 'bar',
            ...
            data: _extractData(company_whole, 'value')//[13, 119, 15, 751, 1]
          }
        ]
      },
