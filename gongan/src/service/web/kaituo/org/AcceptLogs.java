 ...
 *         &lt;element name="Logs" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "regID", "sendID", "logType", "logs" })
@XmlRootElement(name = "acceptLogs")
public class AcceptLogs {
	...
	@XmlElementRef(name = "LogType", namespace = "http://service.web.kaituo.org", type = JAXBElement.class)
	protected JAXBElement<String> logType;
	@XmlElementRef(name = "Logs", namespace = "http://service.web.kaituo.org", type = JAXBElement.class)
	protected JAXBElement<String> logs;
	...
	public void setLogType(JAXBElement<String> value) {
		this.logType = ((JAXBElement<String>) value);
	}
	 ...
	 * 
	 */
	public JAXBElement<String> getLogs() {
		return logs;
	}
	 ...
	 * 
	 */
	public void setLogs(JAXBElement<String> value) {
		this.logs = ((JAXBElement<String>) value);
	}
