...
@XmlRootElement(name = "acceptLogsResponse")
public class AcceptLogsResponse {

	@XmlElementRef(name = "return", namespace = "http://service.web.kaituo.org", type = JAXBElement.class)
